...
{
    public class RegistryValueNode : ParentNodeContainer<string>
    {
        public string ValueName { get; private set; }
        public object ValueObject { get; private set; }
        public RegistryValueKind ValueType { get; private set; }

        public RegistryValueNode(XPathNodeBase parent, string name, RegistryValueKind type, object value)
            : base(parent)
        {
            ValueName = name;
            ValueType = type;
